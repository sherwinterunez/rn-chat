...
class GiftedChat extends React.Component {
  ...
  prepareMessagesContainerHeight(value) {
    if (this.props.isAnimated === true) {
      //console.log('prepareMessagesContainerHeight',value);
  ...
  onKeyboardWillShow(e) {
    ...
    //console.log('GiftedChat.js: onKeyboardWillShow()');
    //console.log(e);
    ...
    //const newMessagesContainerHeight = this.state.messagesContainerHeight;

    //console.log('newMessagesContainerHeight',newMessagesContainerHeight);
    //console.log('messagesContainerHeight',this.state.messagesContainerHeight);
    //console.log('MIN_COMPOSER_HEIGHT',MIN_COMPOSER_HEIGHT);
    //console.log('this.getMaxHeight()',this.getMaxHeight());
    //console.log('this.state.composerHeight',this.state.composerHeight);
    //console.log('this.getMinInputToolbarHeight()',this.getMinInputToolbarHeight());
    //console.log('this.getKeyboardHeight()',this.getKeyboardHeight());
    //console.log('this.getBottomOffset()',this.getBottomOffset());
  ...
  onType(e) {
    ...
    //console.log('GiftedChat.js: onType()');
  ...
  render() {
    ...
    if (this.state.isInitialized === true) {
      ...
      //console.log('GiftedChat.js: render() 1');

      //console.log({getMaxHeight:this.getMaxHeight()});
      //console.log({'this.props.height':this.props.height});
          ...
          <View
            ...
            onLayout={(e) => {
              ...
              if (Platform.OS === 'android') {
                ...
                //console.log({getMaxHeight:this.getMaxHeight()});
                //console.log({yHeight:ExtraDimensions.get('STATUS_BAR_HEIGHT')});
                //console.log({'layout':e.nativeEvent.layout});
                //console.log({getIsFirstLayout:this.getIsFirstLayout()});
                //console.log({'this.props.height':this.props.height});
                ...
                if (this.getMaxHeight() !== layout.height && this.getIsFirstLayout() === true) {
                 // this.setMaxHeight(layout.height);
                  ...
                  this.setMaxHeight(typeof(this.props.height)==='number' ? this.props.height : layout.height);

                  this.setState((previousState) => {
                    //console.log('previousState: messagesContainerHeight => '+previousState.messagesContainerHeight);
                ...
                if (this.getMaxHeight() !== layout.height && this.getIsFirstLayout() === false) {
    ...
    //console.log('GiftedChat.js: render() 2');
